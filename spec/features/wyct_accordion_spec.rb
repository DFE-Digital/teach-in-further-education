...
describe 'Accordion components -', :type => :feature do
  ...
  it "should have correct elements" do
    ...
    within accordion1 do
      expect(accordion1).to have_selector 'h3.govuk-heading-m', text: "Subject areas"
      expect(accordion1).to have_selector '.govuk-body', count: 4
    ...
    within accordion2 do
      expect(accordion2).to have_selector 'h3.govuk-heading-m', text: "Subject areas"
