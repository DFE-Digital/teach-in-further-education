...
export const CTA = ({ data }) => {
  ...
  if(ctaType === "Start") {
     return (
       <a href={data.slug} role="button" draggable="false" className="govuk-button govuk-button--start"
    ...
    return (
      <a href={data.slug} className={"govuk-button " + className} data-module="govuk-button">
        {data.title}
      </a>
    )
  }
